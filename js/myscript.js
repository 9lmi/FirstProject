...
jQuery(window).load(function(){
	...
	//Works Carousel
	$('.flexslider.works_carousel').flexslider({
		animation: "slide",
		controlNav: false,
		slideshow: false, 
		startAt: 1
...
jQuery(window).load(function() {
	if ($(window).width() > 1025){
		...
		jQuery('.services_block').parallax("50%", -0.5);
		jQuery('.inform_block').parallax("50%", -0.5);
	}
...
/*-----------------------------------------------------------------------------------*/
$(document).ready(function(){
	var vague = $(".project_item img").Vague({intensity:3.5});
	vague.blur();
});
